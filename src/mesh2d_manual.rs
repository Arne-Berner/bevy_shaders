...
fn star(
    ...
    let mut v_pos = vec![[-1.0, 1.0, 0.0], [-1., -3., 0.], [3., 1., 0.]];
...
impl FromWorld for ColoredMesh2dPipeline {
    fn from_world(world: &mut World) -> Self {
        let shader: Handle<Shader> = world.load_asset("shader.wgsl");
        Self {
...
impl SpecializedRenderPipeline for ColoredMesh2dPipeline {
    ...
    fn specialize(&self, key: Self::Key) -> RenderPipelineDescriptor {
        ...
        // TODO change the textureformat to non srgb
...
impl Plugin for ColoredMesh2dPlugin {
    fn build(&self, app: &mut App) {
        ...
        let shaders: Handle<Shader> = app.world().load_asset("shader.wgsl");
...
pub fn queue_colored_mesh2d(
    ...
    for (view_entity, visible_entities, view, msaa) in &mut views {
        ...
        // TODO change view.hdr to false, to get non srgb
